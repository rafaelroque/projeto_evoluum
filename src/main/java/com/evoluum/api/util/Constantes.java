...
public class Constantes {
	...
	public final static String API_CIDADES_POR_UF ="https://servicodados.ibge.gov.br/api/v1/localidades/estados/%UF%/municipios";
	public final static String API_CIDADES ="https://servicodados.ibge.gov.br/api/v1/localidades/municipios";
